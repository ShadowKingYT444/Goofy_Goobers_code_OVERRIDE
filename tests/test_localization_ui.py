...
class FirmwareSafetyInvariantTests(unittest.TestCase):
    ...
    def test_claw_and_wrist_controls_match_current_mapping(self):
        ...
        self.assertIn("counter_rollers.move(claw_arm_power)", main)
        self.assertIn("WristActionState::seeking", main)
        self.assertIn("E_CONTROLLER_DIGITAL_RIGHT", main)
        self.assertIn("update_wrist_hold()", main)
        self.assertIn("kWristDefaultTargetDeg = 330.00", main)
        self.assertIn("update_wrist_hold(kWristDefaultTargetDeg)", main)
        self.assertIn("kWristDefaultKp = 3.0", main)
        self.assertIn("kWristDefaultKd = 0.08", main)
        self.assertIn("kWristDefaultMaxPower = 45.0", main)
        self.assertIn("kWristDefaultMinPower = 0.0", main)
    ...
    def test_up_a_starts_exact_far_goal_auton(self):
        main = (ROOT / "src" / "main.cpp").read_text(encoding="utf-8")
        autons = (ROOT / "src" / "autons.cpp").read_text(encoding="utf-8")
        self.assertIn("start_toggle_far_goal_auton();", main)
        self.assertIn("E_CONTROLLER_DIGITAL_UP", main)
        self.assertIn("E_CONTROLLER_DIGITAL_A", main)
    ...
    def test_two_cup_red_selector_and_phase_one_route_are_explicit(self):
        ...
        self.assertIn("kStackApproachPower = 80", config)
        ...
        self.assertIn("kStage1ScoreLoweringDeg = 60.0", config)
        self.assertIn("kStage1ExtraCaptureIn = 4.0", config)
        ...
        self.assertIn("kStage1ScoreRetreatIn = 11.0", config)
        self.assertIn("kStage2ExtraCaptureIn = 4.0", config)
        self.assertIn("kStage2GoalDriveIn = 12.0", config)
        self.assertIn("kStage2ScoreLoweringDeg = 60.0", config)
        ...
        self.assertLess(intake_at_halfway, slow_capture)
        self.assertIn("no additional five-inch movement", route)
        ...
        self.assertIn("path2_fast_turn(-145.0, true, 5.0)", route)
        ...
        self.assertIn("Path2WristService wrist", route)
        self.assertIn("constexpr double kTargetDeg = 330.0", route)
