...
class TournamentUiIsolationTests(unittest.TestCase):
    ...
    def test_serial_reader_reselects_a_silent_or_wrong_port(self):
        ...
        self.assertIn("P1 Distance, P12 IMU, P7 GPS, P6 AI Vision", source)
...
class FirmwareSafetyInvariantTests(unittest.TestCase):
    ...
    def test_claw_and_wrist_controls_match_current_mapping(self):
        ...
        self.assertIn("kArmNormalTargetDeg = 64.7", main)
        ...
        self.assertIn("kArmPositionDownKp = 2.10", main)
        self.assertIn("kArmPositionDownMaxPower = 110.0", main)
        self.assertIn("kArmPositionDownMinPower = 24.0", main)
        ...
        self.assertIn("toggle_piston_was_pressed", main)
        self.assertIn("TOGGLE_STATE phase=opcontrol_a", main)
        ...
        self.assertNotIn("clamp_piston.set_value(true)", startup)
        self.assertNotIn("clamp_output_high.store(true", startup)
        self.assertIn("clamp_output_high.store(false", startup)
    ...
    def test_two_cup_red_selector_and_phase_one_route_are_explicit(self):
        ...
        self.assertIn("kPhase1DrivePower = 75", config)
        ...
        self.assertIn("constexpr double kPneumaticGrabLeadIn = 9.4", route)
        self.assertIn("second_stack_grab_lead_in = blue_side ? 4.65 : 3.90", route)
        ...
        self.assertIn("final 9.4 inches based on the latest loaded test", route)
    ...
    def test_ai_vision_readers_get_one_complete_published_frame(self):
        ...
        self.assertIn("kAiVisionPort = 6", config)
