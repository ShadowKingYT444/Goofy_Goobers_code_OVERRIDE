...
class FirmwareSafetyInvariantTests(unittest.TestCase):
    ...
    def test_ai_bearing_sign_and_duplicate_goal_margin_are_not_mirrored(self):
        ...
        self.assertIn("kFusedTurnMinPower = 28.0", source)
        self.assertIn("kFusedTurnBreakawayPower = 36.0", source)
        self.assertIn("kFusedTurnBreakawayDelayMs = 200", source)
    ...
    def test_port_nine_is_exclusively_the_slider_motor(self):
        ...
        self.assertIn("slider_left.move(!pose_editor_active ? slider_power : 0)", main)
        self.assertIn("slider_right.move(!pose_editor_active ? slider_power : 0)", main)
    ...
    def test_claw_controls_use_adi_h_and_are_pose_editor_safe(self):
        ...
        self.assertIn("const int claw_wrist_power = pose_editor_active", main)
    ...
    def test_public_go_to_pose_is_curved_bounded_and_heading_complete(self):
        ...
        self.assertIn("motion_sign > 0.0 && forward_command > 0.0", source)
        self.assertIn(
